...
class RecoveryActivity : BaseMVPActivity<BreedPresenterImpl>(),
    ...
    override fun initViews(savedInstanceState: Bundle?) {
        ...
        mLayoutOysterNum.getEdView()?.isEnabled = false
        mTvState.getEdView()?.isEnabled = false
        mLayoutName.getEdView()?.isEnabled = false
        mLayoutPhone.getEdView()?.isEnabled = false
        mLayoutTime.getEdView()?.isEnabled = false
